...
from misc_utils.train_utils import get_models, get_diffusion_trainer, get_logger, get_callbacks, get_dataset
...
if __name__ == '__main__':
    ...
    diffusion_configs = args.diffusion_trainer
    pl_model = get_diffusion_trainer(
        models,
